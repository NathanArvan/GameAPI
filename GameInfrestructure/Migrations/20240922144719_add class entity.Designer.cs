...
namespace GameInfrestructure.Migrations
{
    ...
    [Migration("20240922144719_add class entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameDomain.CharacterClass", b =>
                {
                    b.Property<int>("CharacterClassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CharacterClassId"), 1L, 1);
            ...
            modelBuilder.Entity("GameDomain.Classes.Class", b =>
                {
                    b.Property<int>("ClassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameDomain.Users.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameDomain.CharacterClass", b =>
                {
                    ...
                    b.HasOne("GameDomain.Classes.Class", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameDomain.Characters.Character", b =>
                {
                    ...
                    b.HasOne("GameDomain.Users.User", "User")
                        .WithMany("Characters")
